...
if tab == "Chatting":
    ...
    if len(st.session_state.chatbot3_messages) > 0:
        ...
        with col2:
            delete_history_button = st.button(":small[Delete conversation history]", on_click=delete_history_button_clicked, disabled=st.session_state.chat3_disable)
    ...
    if submitted:
        base.handle_submissions("ChatBot 3", radio, slider1, slider2, slider3, st.session_state.chatbot3_messages)
