...
first_person_hedging = """You are only allowed to answer questions that are directly connected to the information given above. Only use the given information above for your answer. Do not refer to the information like an external source, always frame it as your own information/strategy. Help me by giving me your recommendation/advice in the following way:
