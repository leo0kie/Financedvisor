...
st.markdown("""
You are invited to participate in the online study "Confidence of Chatbots". The study is conducted by Leonard Kiefner and supervised by Laura Spillner from the University of Bremen. The study with estimated 50 participants takes place in the period from 2025-07-20 to 2025-08-03. Please note:  
""")
...
st.markdown("""
This study is conducted as part of a bachelor thesis. Its goal is to find a relationship between the usage of linguistic forms of hedging in chatbots and an increased confidence/trust perceived by the user. Your participation will help us achieve this research goal. The results of this research may be presented at scientific or professional meetings or published in scientific proceedings and journals.
""")
...
st.markdown("The confirmation of participation in this study can be obtained directly from the researchers.")
...
st.markdown("""
    ...
    we will log your input. We plan to publish the results of this and other research studies in academic articles or other media. Your data will not be retained for longer than necessary or until you contact researchers to have your data destroyed or deleted. Access to the raw data, transcribed interviews, and observation protocols of the study 
