...
if tab == "Chatting":
    ...
    eval, radio, slider1, slider2, slider3, select, number = base.generate_evaluation("chat1")
    ...
    if submitted and not st.session_state.evaluation_finished:
        ...
        if not has_error:
            eval_button_clicked()
            base.handle_submissions("ChatBot 1", radio, slider1, slider2, slider3, select, number, chat_bot1.chat_history)
